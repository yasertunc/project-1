...
router.post(
  "/:channelId/messages",
  messageRateLimiter,
  validateRequest(messageRequestSchema),
  channelController.sendMessage.bind(channelController)
);
router.get(
  "/:channelId/messages",
  channelController.getMessages.bind(channelController)
);
router.post(
  "/:channelId/close",
  channelController.close.bind(channelController)
);

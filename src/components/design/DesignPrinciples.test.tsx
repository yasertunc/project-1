...
describe("DesignPrinciples", () => {
  ...
  test("renders typography scale section", () => {
    ...
    expect(screen.getByText(/Apple\/Google sistem fontları/i)).toBeInTheDocument();
  });
  ...
  test("renders principle summaries", () => {
    ...
    expect(screen.getByText(/Information density stays comfortable/i)).toBeInTheDocument();
    expect(screen.getByText(/All movement follows the shared easing curve/i)).toBeInTheDocument();
    expect(screen.getByText(/Components snap to the 4\/8\/12 grid/i)).toBeInTheDocument();
  });
  ...
  test("renders principle bullets", () => {
    ...
    expect(screen.getByText(/Vertical stacks rely on 15px/i)).toBeInTheDocument();
  });
